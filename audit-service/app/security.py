...
def get_current_user(authorization: Optional[str] = Header(default=None)) -> CurrentUser:
    """
    Valida el mismo JWT emitido por el Servicio de Autenticacion (comparten
    JWT_SECRET). Asi cada servicio valida el token de forma independiente,
    sin tener que consultar al servicio de autenticacion en cada request.
    """
